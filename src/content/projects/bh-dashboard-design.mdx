...
import bhDashboardDashboardImageWebp from '@assets/bh-dashboard/dashboard-image.webp';
import bhDashboardGoogleAnalyticsWebp from '@assets/bh-dashboard/google-analytics.webp';
import bhDashboardKpisWebp from '@assets/bh-dashboard/kpis.webp';
...
<Image
  ...
  format="webp"
  src={bhDashboardGoogleAnalyticsWebp}
  quality="max"
