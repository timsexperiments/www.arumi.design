...
import smartSchedulerBookingRulesPng from '@assets/smart-scheduler/booking-rules.png';
import smartSchedulerMoodboardPng from '@assets/smart-scheduler/moodboard.png';
import smartSchedulerTtaPng from '@assets/smart-scheduler/tta.png';
import smartSchedulerUserInterviewPng from '@assets/smart-scheduler/user-interview-and-journey-map.png';
import smartSchedulerUserPersonaPng from '@assets/smart-scheduler/user-persona.png';
...
<LeftRight align="middle">
    ...
    <Image
        ...
        class="w-full h-auto"
        format="webp"
        src={smartSchedulerMoodboardPng}
...
<LeftRight first="right" align="middle">
    <Image
        ...
        align="middle"
        format="webp"
        src={smartSchedulerUserInterviewPng}
    ...
    <LeftRight rightText="left" leftWidth="3/5" rightWidth="2/5" noSpacing>
        <div>
            <div class="flex items-top gap-2">
                <Image format="webp" class="h-32 w-32 my-2 inline-block" src={smartSchedulerUserPersonaPng} alt="User persona"/>

                Christina is the proud mom of 2 kids. She's married, in her late 40s, and has been working for the clinic for the past 10 years. She's risen through the ranks up to VP of Centers. She loves her job and wants to have a positive impact in the company.
            </div>
...
<Image
  ...
  src={smartSchedulerBookingRulesPng}
  alt="User persona"
/>
