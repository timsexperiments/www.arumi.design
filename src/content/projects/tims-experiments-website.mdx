...
import moodBoardWebp from '@assets/tims-experiments/mood-board.webp';
...
<Image
  class="m-auto h-auto w-[976px] max-w-full"
  format="webp"
  src={moodBoardWebp}
  quality="max"
  alt="Mood board"
...
<iframe
  class="m-auto aspect-[1440_/_1024] w-full"
  src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FdUc5it2HDgJwOXrpOaG7V5%2FTim's-Experiments-UI%3Fkind%3Dproto%26node-id%3D238-969%26page-id%3D5%253A17749%26scaling%3Dscale-down%26starting-point-node-id%3D238%253A969%26t%3D169F5OGQukSfpl2K-1%26type%3Ddesign%26viewport%3D111%252C-2768%252C0.19%26mode%3Ddesign"
